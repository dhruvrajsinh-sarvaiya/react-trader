                                ...
                                activeMyOpenData.map((value, key) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="text-center">
                                            {value.Price === 0 ? <IntlMessages id="trading.placeorder.label.market" /> : value.StatusCode === 1 ? parseFloat(value.SettlementPrice).toFixed(8) : parseFloat(value.Price).toFixed(8)}
                                            </td>
                                            <td className="text-center">
                                                {parseFloat(
                                                    value.Amount
