...
module.exports = function validateTradeLimitRequest(data) {
    ...
    if (validator.isEmpty(data.LimitPerHour)) {
        errors.tradeLimitHour = "apiWalletErrCode.4211";
    } else if (
    ...
    if (validator.isEmpty(data.LimitPerDay)) {
        errors.tradeLimitDay = "apiWalletErrCode.4212";
    } else if (
    ...
    if (validator.isEmpty(data.LimitPerTransaction)) {
        errors.tradeLimitTrn = "apiWalletErrCode.4213";
    } else if (
    ...
    if (validator.isEmpty(data.LifeTime)) {
        errors.tradeLifeTimeLimit = "wallet.LCInvalidLifeTimeLimitRequired";
    } else if (
