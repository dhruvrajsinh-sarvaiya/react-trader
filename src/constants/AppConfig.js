...
//const APIURL = 'http://192.168.31.238:60030/';

const APIURL = 'https://cleandevtest.azurewebsites.net/SSOAccountStaging/';
const AppConfig = {
    ...
    //socketUrl: "http://192.168.31.64:4001/", // Add Socket Url By Tejas
	socketUrl: "http://192.168.31.186:4545/", 
    ...
    referral_link:"https://new-stack-front.azurewebsites.net/signup?ref=",
    ...
    defaultDarkMode:false, // code added by devang parekh for set default dark mode after login if true than default dark mode otherwise not
    // code added for connect ticker of an socket
    tickerChannelID:10001, // for ticker method
    balanceChannelID:10002 // for balance method
}
